...
export function AddExpenseForm({ onSuccess, groups = [] }: AddExpenseFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 pt-4">
      ...
      <div className="grid gap-2">
        <Label>Paid by</Label>
        <RadioGroup value={formData.paidBy} onValueChange={(value) => handleSelectChange("paidBy", value)}>
      ...
      <div className="grid gap-2">
        ...
        <RadioGroup value={formData.splitMethod} onValueChange={(value) => handleSelectChange("splitMethod", value)}>
          <div className="flex items-center space-x-2">
