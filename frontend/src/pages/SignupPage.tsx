...
import { Eye, EyeOff, Lock, Mail, User, ArrowLeft, ShieldAlert } from "lucide-react";
...
export default function SignupPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#030712] text-slate-100 overflow-hidden px-4 py-12">
      {/* Ambient background */}
      <div className="absolute top-[-15%] right-[-10%] h-[600px] w-[600px] bg-indigo-600/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] h-[500px] w-[500px] bg-purple-600/8 rounded-full blur-[100px] pointer-events-none" />
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            {error && (
              <div className="flex items-start gap-3 p-4 rounded-2xl bg-rose-500/8 border border-rose-500/20 text-rose-300 text-sm">
                ...
                <div>
                  <p className="font-semibold text-rose-300">Registration failed</p>
