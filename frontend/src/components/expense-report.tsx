  ...
  const loadData = async () => {
    try {
      ...
      toast({
        ...
        description: error.message || "Failed to load expenses/groups",
        variant: "destructive",
      });
    }
  };
        ...
        <div className="flex flex-col gap-4 md:flex-row print:hidden">
          <Select value={selectedGroup} onValueChange={setSelectedGroup}>
            ...
            <SelectContent>
              ...
              {groups.map((group) => (
                <SelectItem key={group._id || group.id} value={group.name}>
                  {group.name}
                </SelectItem>
              ))}
            </SelectContent>
            ...
            <div className="space-y-6">
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      ${youPaidTotal.toFixed(2)}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      {
                        filteredExpenses.filter((e) => e.type === "you_paid")
                          .length
                      }{" "}
                      expenses
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {
                        filteredExpenses.filter((e) => e.type === "you_owe")
                          .length
                      }{" "}
                      expenses
                    </p>
